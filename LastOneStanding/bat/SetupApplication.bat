...
:: Android packaging
set AND_CERT_NAME="LastOneStanding"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\LastOneStanding.p12
...
set IOS_PROVISION=cert\LastOneStanding.mobileprovision
...
set APP_ID=air.LastOneStanding

:: Output packages
set DIST_PATH=dist
set DIST_NAME=LastOneStanding
